...
class LoginPage extends Page {
  ...
  logout() {
    ...
    // const burgerMenu = element(by.xpath('//*[@id="main-content"]/app-dashboard/ion-header/ion-toolbar/ion-buttons[1]'));
    // console.log('start of waiting for burger menu');
    // browser.wait(ExpectedConditions.elementToBeClickable(burgerMenu));
    // console.log('end of waiting for burger menu');
    // console.log('start of clicking burger menu');
    // burgerMenu.click();
    // console.log('end of clicking burger menu');
